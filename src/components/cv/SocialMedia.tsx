    ...
    return (
        <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
                {data.map((sm, index) => (
                    <div key={index} className="flex items-center gap-2 hover:cursor-pointer hover:text-blue-600 hover:underline">
                        <span dangerouslySetInnerHTML={{ __html: sm.icon }} />
